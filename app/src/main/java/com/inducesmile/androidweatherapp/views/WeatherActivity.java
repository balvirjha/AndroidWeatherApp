        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, apiUrl, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (null == locationMapObject) {
                    ...
                    String sunrise = new SimpleDateFormat("HH:mm").format(new java.util.Date((long) new Long(locationMapObject.getSys().getSunrise()) * 1000));
                    String sunset = new SimpleDateFormat("HH:mm").format(new java.util.Date((long) new Long(locationMapObject.getSys().getSunset()) * 1000));
